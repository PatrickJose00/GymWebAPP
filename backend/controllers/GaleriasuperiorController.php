...
use Yii;
use backend\models\Galeriainicial;
 ...
 */
class GaleriasuperiorController extends Controller {
    ...
    public function actionIndex() {
        $imagensGaleria = Galeriainicial::find();
    ...
    public function actionCreate() {
        $model = new Galeriainicial();
        $model->scenario = Galeriainicial::SCENARIO_FILE;
    ...
    protected function findModel($id) {
        if (($model = Galeriainicial::findOne($id)) !== null) {
            return $model;
        } else {
            return $this->redirect(['index']);
        }
