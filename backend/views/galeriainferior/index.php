...
$this->registerJs($js);
?>
<div class="galeriainferior-index">
    ...
    <?php endif; ?>
    <?= Html::a('<h4><span class="btn btn-success margin-btn-add"><i class="fa fa-plus" aria-hidden="true"></i> Adicionar Imagem</span></h4>', Url::to(['galeriainferior/create']), ['title' => 'Adicionar Imagem', 'alt' => 'Adicionar Imagem']); ?>
    <div class="row ">
        <div class="col-xs-12">
            <div class="box">
                            ...
                            if (!empty($imagensGaleria)):
                                foreach ($imagensGaleria as $imagem):
                                    ...
                                    <div class="col-lg-3 col-sm-6 col-xs-6">
                                        <div class="thumbnail ">
                                            <?= Html::img(Yii::getAlias('@web') . '/../frontend/web/gallery-inside/' . $imagem->Imagem, ['class' => 'center-block imagem-tamanho', 'alt' => $imagem->Nome, 'title' => $imagem->Nome]); ?>
                                            <label><?= $imagem->Nome = ((strlen($imagem->Nome)) >= 25 ? mb_substr($imagem->Nome, 0, 25) . '...' : $imagem->Nome) ?></label>
                                            <div class="pull-right">
                                                <?= Html::a('<span class="btn btn-warning btn-xs margin-btn-label"><i class="fa fa-pencil" aria-hidden="true"></i></span>', Url::to(['galeriainferior/update', 'id' => $imagem->id]), ['data-toggle' => 'tooltip', 'title' => Yii::t('app', 'Atualizar')]); ?>
                                                <?=
                                                Html::a('<span class="btn btn-danger btn-xs margin-btn-label"><i class="fa fa-trash" aria-hidden="true"></i></span>', Url::to(['galeriainferior/delete', 'id' => $imagem->id]), ['data' => [
