    ...
    <div class="box box-primary">
        ...
        <div class="box-body">
            ...
            if (!$model->isNewRecord) {
                echo Html::img(Yii::getAlias('@web') . '/../frontend/web/gallery-top/' . $model->Imagem, ['class' => 'img-thumbnail', 'width' => '250', 'alt' => $model->Nome, 'title' => $model->Nome]);
            }
            ?>
            <?= $form->field($model, 'Nome', ['template' => '{label}{input}<span class="help-block">{hint}{error}</span>'])->textInput(['maxlength' => true, 'placeholder' => Yii::t('app', 'Piscina Interior')]) ?>
