...
class User extends ActiveRecord implements IdentityInterface {
    ...
    public function rules() {
        return [
            ...
            [['password'], 'required', 'message' => 'A password não pode ficar em branco'],
            [['novaPassword', 'confirmarPassword', 'password'], 'string'],
    ...
    public function verificarPassword() {
        if (Yii::$app->getSecurity()->validatePassword($this->password, $this->password_hash)) {
            ...
            $this->addError('password', 'Insira a password correta');
            return false;
        }
    }
    ...
    public function getCliente() {
        return $this->hasOne(\backend\models\Cliente::className(), ['User_id' => 'id']);
    }
